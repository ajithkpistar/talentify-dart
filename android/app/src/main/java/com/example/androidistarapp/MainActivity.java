package com.example.androidistarapp;
...
public class MainActivity extends FlutterActivity implements RecognitionListener {
  ...
  private static final String LOG_TAG = "Talentify";
  ...
  private void sendTranscription(boolean isFinal) {
    speechChannel.invokeMethod(isFinal ? "onRecognitionComplete" : "onSpeech", transcription);
  }
